...
export default function DefaultChatContainer() {
          ...
          <div>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-5 w-fit transition-all duration-300 border border-slate-200 px-4 py-2 rounded-lg text-white light:border-black/50 light:text-theme-text-primary text-sm items-center flex gap-x-2 hover:bg-slate-200 hover:text-slate-800 focus:ring-gray-800 shadow-sm"
              >
  ...
  return (
    <div
      ...
      className={`transition-all duration-500 relative md:ml-[2px] md:mr-[16px] md:my-[16px] md:rounded-[20px] bg-theme-bg-secondary light:border-[1px] light:border-theme-sidebar-border w-full h-full overflow-y-scroll ${
...
function MessageText({ children }) {
  return (
    <span className="text-white/90 light:text-theme-text-primary font-light text-[15px] flex flex-col gap-y-1.5 mt-2 leading-relaxed">
      {children}
    </span>
  );
}
